...
function NavbarComponent() {
  ...
  return (
    <>
      <nav className="flex h-16 items-center justify-between bg-white shadow dark:bg-gray-800 sticky top-0 z-50 ">
        <div className="pl-2">
        ...
        <div className="max-[450]:block md:hidden sm:hidden">
          <button
            className="px-2 py-2 hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500"
            onClick={(e) => {
              setvisibilityState(
                visibilityState === "hidden" ? "block" : "hidden"
              );
            }}
          >
            Show
        ...
        <div className={`max-[450px]:${visibilityState} max-sm:absolute max-sm:top-16 max-sm:right-0.5`}>
          <div className="container md:flex md:items-center md:justify-between p-4 mx-auto text-gray-600 capitalize dark:text-gray-300 max-sm:flex max-sm:flex-col max-sm:w-full max-sm:bg-white max-sm:items-center max-sm:rounded-bl-lg">
            <a
              href="#"
            ...
            <a
              href="#about"
              className="border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6 max-sm:mt-2"
            >
              About Us
            </a>
            ...
            >
              <svg
                className="w-4 h-4 fill-current max-sm:mt-2"
                viewBox="0 0 24 24"
                fill="none"
