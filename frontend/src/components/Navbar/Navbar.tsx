...
function NavbarComponent() {
    return (
        <>
            <nav className="flex items-center bg-white shadow dark:bg-gray-800 sticky top-0 z-50 ">
                <div className='pl-2'>
                ...
                <div className="container flex items-center justify-end p-4 mx-auto text-gray-600 capitalize dark:text-gray-300">
                    ...
                    <a href="#product" className="border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">Products</a>

                    <a href="#contact" className="border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">Contact Us</a>
